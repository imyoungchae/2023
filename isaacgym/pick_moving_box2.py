...
class FrankaCubeStack(VecTask):
    ...
    def __init__(self, cfg, rl_device, sim_device, graphics_device_id, headless, virtual_screen_capture, force_render):
        ...
        self.conveyor_default_vel=to_torch([0.75], device=self.device)
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        cubeA_color = gymapi.Vec3(0.7,0.1,0.1)
        ...
        for i in range(self.num_envs):
            ...
            self.gym.set_dof_target_velocity(env_ptr,target_dof_actor,0.75)
    ...
    def init_data(self):
        ...
        self.handles = {
            ...
            "table_handle":self.gym.find_actor_rigid_body_handle(self.envs[0], self.table_stand_actor, "table_box"),
        }
        ...
        self._table_stand_actor_state = self._root_state[:, self.table_stand_actor, :]
    ...
    def post_physics_step(self):
        ...
        # debug viz
        if self.viewer != None:
            cam_pos = gymapi.Vec3(0.5,0.5,3.0)
...
def compute_franka_reward(
    ...
    cubeA_lifted = ((cubeA_height - cubeA_size) > 0.085)
    ...
    cubeA_align_cubeB = (torch.norm(states["cubeA_pos"][:, :2] - states["table_box_pos"][:, :2], dim=-1) < 0.02)
    cubeA_on_cubeB = torch.abs(cubeA_height - target_height) < 0.75
